# Plateforme Gaming — Marketplace (Phase 1)
...
2. Copie `.env.local.example` vers `.env.local` et renseigne :
   - `NEXT_PUBLIC_SUPABASE_URL`
   - `NEXT_PUBLIC_SUPABASE_ANON_KEY`
   (les deux se trouvent dans Project Settings → API)
3. Ouvre l'éditeur SQL de Supabase et exécute tout le contenu de `schema.sql`
